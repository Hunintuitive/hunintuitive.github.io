...
Ich habe sowohl Geschäftskunden als auch Privatpersonen in den folgenden Bereichen umfassende Unterstützung geboten:

- **Desktop-Support:** Beherrschung der Desktop-Betriebssysteme Windows XP, 7, 10, 11 und Linux Desktop.
- **Software-Support:** Fachkenntnisse in Microsoft Office, Software-Installation und -Entfernung sowie grundlegende Skripting/CLI-Nutzung.
- **Fernzugriffslösungen:** Erfahrung mit Citrix und der Ferninstallation von Betriebssystemen unter Verwendung von SCCM sowie mit der Unterstützung einer virtuellen Desktop-Infrastruktur (VDI) oder individuellem Support über TeamViewer.
- **Netzwerk-Support:** Erfahren in der Verwaltung von VPN-Konnektivität und der Lösung von netzwerkbezogenen Problemen.
- **Benutzerverwaltung:** Erfahren in der Verwaltung von Active Directory-Benutzern und -Computern, im Umgang mit Benutzerprofilen.
- **Hardware-Support:** Umfassende Erfahrung im Support von Laptops, PCs und mobilen Geräten, einschließlich Drucker- und Thin-Client-Support.

Mein Ansatz kombiniert technisches Fachwissen mit einem Engagement für den Kundenservice, was es mir ermöglicht, Probleme effektiv zu lösen und gleichzeitig positive Beziehungen zu meinen Kunden zu pflegen. Meine Leidenschaft ist die Nutzung von Technologie zur Verbesserung der Benutzererfahrung.
